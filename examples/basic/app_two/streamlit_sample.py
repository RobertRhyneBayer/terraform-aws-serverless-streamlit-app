...
with col2:
    st.text("You have successfully deployed a SECOND serverless Streamlit App with Terraform!")
    st.text("This SECOND solution uses VPC, ECS, Application Load Balancer, and CloudFront.")
